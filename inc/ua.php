...
function user_agent_show(){
    ...
    if($title&&$btitle){
        ...
        return '<div class="useragent"><img src="https://gaoice.ba7jcm.live/wp-content/themes/kratos-pjax-master/static/images/ua/'.$bcode.'.png" style="margin-top:-3px;width:16px;height:16px"> '.$btitle.' <img src="https://gaoice.ba7jcm.live/wp-content/themes/kratos-pjax-master/static/images/ua/'.$code.'.png" style="margin-left:5px;margin-top:-3px;width:16px;height:16px"> '.$title.' '.$version.'</div>';
    }else return null;
}
